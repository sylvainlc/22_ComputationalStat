...
&= \mathbb{E}_q\left[\log p(\sigma^2) + \log p(\mu|\sigma^2) + \log p(x|\mu,\sigma^2)\right] - \mathbb{E}_{q_\mu}\left[\log q_{\mu}(\mu)\right] - \mathbb{E}_{q_{\sigma^2}}\left[\log q_{\sigma^2}(\sigma^2)\right]\,.
\end{align*}
}
