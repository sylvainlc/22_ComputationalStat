...
$$
which concludes the proof. The ineqality $\int \log(p_\theta(z))p_{\theta'}(z)\lambda(\rmd z) \leq \int \log(p_{\theta'}(z))p_{\theta'}(z)\lambda(\rmd z)$ is known as Gibbs' inequality.
\end{proof}
